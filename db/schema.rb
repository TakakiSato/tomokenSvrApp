...
ActiveRecord::Schema.define(version: 20160601133238) do

  create_table "course_details", id: false, force: true do |t|
  ...
  add_index "course_details", ["course_detail_id", "course_id"], name: "composit", unique: true, using: :btree
